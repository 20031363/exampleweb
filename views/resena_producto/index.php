...
<div style="align-items:center;text-align:center;margin-top:5%;margin-bottom:5%;">
    <h1 class="generic-font" style="color: rgb(31, 43, 33)!important; font-weight:bolder;text-align:center;">Reseñas de Libros:</h1>
    <?php if($app->checar('Admin')): ?>
    <a href="resena_producto.php?accion=crear" class="btn btn-success botones-genf">Nueva Reseña</a>
    <?php endif; ?>
</div>
...
<div style="place-items:center; align-items:center; text-align:center; margin:5%;">
    <table class="table" style="font-size:1.3rem; font-weight:bolder;border-color:black;">
        <thead>
            <tr>
                <th scope="col" style="background-color: rgb(33, 46, 37)!important; color:white;">ID Reseña</th>
                <th scope="col" style="background-color: rgb(33, 46, 37)!important; color:white;">Reseña</th>
                <th scope="col" style="background-color: rgb(33, 46, 37)!important; color:white;">Calificacion</th>
                <th scope="col" style="background-color: rgb(33, 46, 37)!important; color:white;">Fecha Reseña</th>
                <th scope="col" style="background-color: rgb(33, 46, 37)!important; color:white;">Libro Titulo</th>
                ...
                <tr>
                    ...
                    <?php if($app->checar('Admin')): ?>
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a class="btn btn-primary botones-genf" href="resena_producto.php?accion=modificar&id=<?php echo $producto['id_resena']; ?>">Modificar</a>               
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalLabel<?php echo $producto['id_resena']; ?>">Eliminar Reseña</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        ¿Está seguro de que desea eliminar esta reseña?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                        <a class="btn btn-danger botones-genf" href="resena_producto.php?accion=eliminar&id=<?php echo $producto['id_resena']; ?>">Eliminar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
