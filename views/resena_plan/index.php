...
<div style="align-items:center;text-align:center;margin-top:5%;margin-bottom:5%;">
    <h1 class="generic-font" style="color: rgb(31, 43, 33)!important; font-weight:bolder;text-align:center;">Evaluacion de Mentorias:</h1>
    <?php if($app->checar('Admin')): ?>
    <a href="resena_plan.php?accion=crear" class="btn btn-success botones-genf">Nueva Evaluacion</a>
    <?php endif; ?>
</div>
    ...
    <table class="table" style="font-size:1.3rem; font-weight:bolder;border-color:black;">
        <thead>
            <tr>
                ...
                <th scope="col" style="background-color: rgb(33, 46, 37)!important; color:white;">Evauacion</th>
                ...
                <th scope="col" style="background-color: rgb(33, 46, 37)!important; color:white;">Mentoria Evaluada</th>
                ...
                <tr>
                    ...
                    <?php if($app->checar('Admin')): ?>
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a class="btn btn-primary botones-genf" href="resena_plan.php?accion=modificar&id=<?php echo $producto['id_resena']; ?>">Modificar</a>               
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-danger botones-genf" href="resena_plan.php?accion=eliminar&id=<?php echo $producto['id_resena']; ?>">Eliminar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
