<div style="background-color: rgba(51, 45, 119, 1)!important; color: white; font-weight:bold; text-align:center;justify-content:center;align-items:center;padding-top:3%;padding-bottom:3%;">
<div class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top" style="margin-left:5%;margin-right:5%;padding: 0%; background-color: rgba(51, 45, 119, 1)!important;">
    <p class="col-md-4 mb-0 text-body-secondary" style="color:white !important; font-size:1rem !important; font-weight:bold !important; text-align:center !important; background-color: rgba(51, 45, 119, 1)!important;">ConectaTEC 2025 Company, Inc</p>
