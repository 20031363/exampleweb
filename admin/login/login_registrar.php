...
<section class="login-hero text-center text-white d-flex align-items-center justify-content-center" style="
  ...
  <div class="container position-relative">
    <h1 class="display-4 fw-bold">Hola que tal!!  ¿Quieres Unirte?</h1>
    <p class="lead">Registra una nueva cuenta.</p>
  </div>
</section>
    ...
    <div class="col-md-8">
      <div class="card shadow-lg">
        <div class="card-body p-5">
          ...
          <form method="POST" action="login.php?accion=crear">

            <div class="mb-3">
              <label for="nombre" class="form-label">Nombre</label>
              <input type="text" class="form-control" id="nombre" name="datos[nombre]" placeholder="Nombre" required>
            </div>

            <div class="mb-3">
              <label for="apellido1" class="form-label">Primer Apellido</label>
              <input type="text" class="form-control" id="apellido1" name="datos[primer_apellido]" placeholder="Primer Apellido" required>
            </div>

            <div class="mb-3">
              <label for="apellido2" class="form-label">Segundo Apellido</label>
              <input type="text" class="form-control" id="apellido2" name="datos[segundo_apellido]" placeholder="Segundo Apellido" required>
            </div>

            <h4 class="text-center mt-4 mb-3">Datos de Acceso</h4>

            <div class="mb-3">
              <label for="correo" class="form-label">Correo Electrónico</label>
              <input type="email" class="form-control" id="correo" name="datos[correo]" placeholder="Correo electrónico" required>
            </div>

            <div class="mb-3">
              <label for="contrasena" class="form-label">Contraseña</label>
              <input type="password" class="form-control" id="contrasena" name="datos[contrasena]" placeholder="Contraseña" required>
            </div>

            <input type="hidden" name="datos[id_usuario]" value="0">

            <div class="d-grid gap-2">
              <input type="submit" class="btn btn-primary btn-lg" name="enviar" value="Guardar Registro">
              <button type="button" onclick="window.location.href='/nutrimentorx/admin/login.php'" class="btn btn-danger btn-lg">Cancelar</button>
            </div>
          </form>
        </div>
      </div>
