<?php
require_once(__DIR__.'/models/usuarios_roles.php');
$web= new Usuario();
    ...
    case 'crear':
        if(isset($_POST['enviar'])){
            ...
            if($resultado){
                ...
                $marca_a=$web->leer();
                $web->alerta($alerta);      
                require_once(__DIR__.'/../views/usuarios_roles/index.php');
            }
            else{
                $alerta['mensaje']='OCURRIO UN PROBLEMA NO SE PUDO CREAR EL USUARIO!!';
                $alerta['tipo']='danger';
                $web->alerta($alerta);      
                include_once(__DIR__.'/../views/usuarios_roles/form.php');    
            }
        }
        else{
            include_once(__DIR__.'/../views/usuarios_roles/form.php');
