<?php
require_once(__DIR__.'/models/resena_producto.php');
require_once(__DIR__.'/models/producto.php');
require_once(__DIR__.'/models/cliente.php');

$web = new ResenaProducto();
    ...
    case 'crear':
        ...
        if(isset($_POST['enviar'])){
            ...
            if (strtotime($datos['fecha_resena']) >= strtotime($hoy)) {
                ...
                $alerta['tipo'] = 'danger';
                $web->alerta($alerta);
                include_once(__DIR__.'/../views/resena_producto/form.php');
                break;
            }
            ...
            if($resultado){
                ...
                $producto_a = $web->leer();
                $web->alerta($alerta);
                require_once(__DIR__.'/../views/resena_producto/index.php');
            } else {
